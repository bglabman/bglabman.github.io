    ...
    */
    ...
    return function(inputConfig) {
        ...
        function createBoardElements() {
            ...
            elmPauseScreen.innerHTML = "<div style='position:sticky; padding:100px;'>[Paused]<p/>Press [space] to unpause.</div>";

            elmAboutPanel = document.createElement("div");
            elmAboutPanel.className = "snake-panel-component";
            elmAboutPanel.innerHTML = "<a href='http://https://bglabman.github.io/'</a>";
